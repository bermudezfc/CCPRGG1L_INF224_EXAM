...
//==================================================================
        ...
        switch (course) {
            case "BSIT":
                System.out.println("What specialization: MWAA or MAA?");
        ...
        break;
            case "BSCS":
                System.out.println("What specialization: ML or DF?");
        ...
        if (studentEmailAddress.contains("bermudez") && studentEmailAddress.contains("@student.national-u.edu.ph")) {
            System.out.println("valid");
        }
        else {
            System.out.println("invalid");
    ...
    static void numberOne(int number) {
    if (number > 0) {
    ...
    static void numberTwo(int lastDigit) {
        ...
        else if (lastDigit == 1 || lastDigit == 4 || lastDigit == 6 || lastDigit == 9) {
    ...
    static void numberThree(String firstName, String surName){
        int firstNameLength = firstName.length();
        int surNameLength = surName.length();
        System.out.println("The length of your first name and your surname is: " + (firstNameLength + surNameLength));

    }
    static void numberFour(int x, int y, int z) {
        if (x > y && x > z) {
    ...
    static void numberFive(char firstChar) {
